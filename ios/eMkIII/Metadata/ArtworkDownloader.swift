...
class ArtworkDownloader {
    // libretro thumbnail base URL
    private static let baseURL = "https://raw.githubusercontent.com/libretro-thumbnails/Sega_-_Master_System_-_Mark_III/master/Named_Boxarts/"
    ...
    @discardableResult
    func download(for crc: String, gameName: String) async -> Bool {
        // Format the game name for the URL
        // libretro thumbnails use the full No-Intro name with special characters replaced
        ...
        do {
            ...
            guard let httpResponse = response as? HTTPURLResponse,
                ...
                // Artwork not found is common - many games don't have thumbnails
                return false
            }
