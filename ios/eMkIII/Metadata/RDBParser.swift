...
struct RDBGameInfo {
    let name: String           // Full No-Intro name
...
class RDBParser {
    ...
    // RDB download URL
    private static let rdbURL = "https://raw.githubusercontent.com/libretro/libretro-database/master/rdb/Sega%20-%20Master%20System%20-%20Mark%20III.rdb"

    // Maximum download size (1MB)
    private static let maxDownloadSize = 1 * 1024 * 1024
    ...
    func lookup(crc32: UInt32) -> RDBGameInfo? {
    ...
    static func getDisplayName(from name: String) -> String {
    ...
    static func getRegion(from name: String) -> String {
...
enum RDBError: Error, LocalizedError {
    case invalidURL
    case downloadFailed
    case fileTooLarge
