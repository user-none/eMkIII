...
// extractFromGzip extracts the first .sms file from a gzip or tar.gz archive
...
// extractFromTar extracts the first .sms file from a tar archive
func extractFromTar(r io.Reader, archivePath string) ([]byte, string, error) {
	tr := tar.NewReader(r)
